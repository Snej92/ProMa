...
export const UPDATE_PROJECT_FAVORITE_SUCCESS = '[dashboard page] update project success'


export const updateProjectFavorite=createAction(UPDATE_PROJECT_FAVORITE, props<{projectId:number, remove:boolean}>())
export const updateDashboardProjectFavoriteSuccess=createAction(UPDATE_PROJECT_FAVORITE_SUCCESS, props<{projectId:number, remove:boolean}>())
