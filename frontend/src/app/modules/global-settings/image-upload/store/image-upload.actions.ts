...
export const loadUploadList=createAction(LOAD_UPLOAD_LIST);
...
export const uploadImage =createAction(UPLOAD_IMAGE, props<{image:FormData}>())
export const uploadImageSuccess =createAction(UPLOAD_IMAGE_SUCCESS, props<{upload:uploadModel}>())

export const deleteImage =createAction(DELETE_IMAGE, props<{imageName:string}>())
