...
import {StationFavoriteEffects} from "./modules/dashboard/station/store/station-favorite.effects";
import { FavoriteProjectWidgetComponent } from './modules/dashboard/project/favorite-project-widget/favorite-project-widget.component';
import { FavoriteStationWidgetComponent } from './modules/dashboard/station/favorite-station-widget/favorite-station-widget.component';
...
import { StationOverviewNoteComponent } from './modules/overview/station/components/station-overview-note/station-overview-note.component';
  ...
  imports: [
    ...
    NgxEditorModule.forRoot({
      locals: {
        ...
        align_justify: 'Bündig',
        text_color: 'Text Farbe',
        background_color: 'Markieren',
