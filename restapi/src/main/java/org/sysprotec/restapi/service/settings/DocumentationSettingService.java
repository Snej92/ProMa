...
import org.sysprotec.restapi.service.overview.DocumentationService;
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (user != null) {
                ...
                if (optionalProject.isEmpty()) {
                    ...
                    for(TaskSetting docu : saveProject.getDocumentationSetting()){

                    }

                    projectRepository.save(saveProject);
                    log.info("DocumentationSetting Punkt: '" + taskSetting.getName() + "' zu '" + saveProject.getName() + "' hinzugefügt");
    ...
    public void deleteDocumentationSetting(Long taskSettingId) {
        ...
        if(optionalTaskSetting.isEmpty() || optionalProject.isEmpty()){
            ...
            for (Station station : stationList) {
                ...
                log.info("Dokumentation : '" + optionalTaskSetting.get().getName() + "' von '" + station.getName() + "' entfernt");
            }
            ...
            log.info("Dokumentation : '" + optionalTaskSetting.get().getName() + "' von '" + saveProject.getName() + "' entfernt");
