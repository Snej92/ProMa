        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (user != null) {
                ...
                if (optionalProject.isEmpty()) {
                    ...
                    log.info("ControlSetting Punkt: '" + taskSetting.getName() + "' zu '" + saveProject.getName() + "' hinzugefügt");
    ...
    public void deleteControlSetting(Long taskSettingId) {
        ...
        if(optionalTaskSetting.isEmpty() || optionalProject.isEmpty()){
            ...
            for (Station station : stationList) {
                ...
                log.info("Kontrolle : '" + optionalTaskSetting.get().getName() + "' von '" + station.getName() + "' entfernt");
            }
            ...
            log.info("Kontrolle : '" + optionalTaskSetting.get().getName() + "' von '" + saveProject.getName() + "' entfernt");
